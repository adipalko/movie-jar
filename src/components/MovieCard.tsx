            ...
            <div className="flex flex-col gap-2 mt-3">
              {movie.status === 'unwatched' && onMarkWatching && movie.content_type === 'tv' && (
                <button
                  ...
                  className="w-full px-3 py-2 bg-slate-700 hover:bg-slate-600 rounded transition-colors flex items-center justify-center gap-2.5"
                ...
                >
                  ...
                  <span className="text-sm text-slate-300 font-medium">Start</span>
                </button>
              )}
              <div className="flex gap-2">
                {movie.status === 'unwatched' && onMarkWatched && (
                  <button
                    ...
                    className="flex-1 px-2 py-1.5 bg-slate-700 hover:bg-slate-600 rounded transition-colors flex items-center justify-center"
